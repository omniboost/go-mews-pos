...
type (
	...
	Product struct {
		...
		VariantOptions                 []ProductVariantOptions `json:"variantOptions"`
	...
	ProductVariant struct {
		...
		RetailPriceInclTax      string                   `json:"retailPriceInclTax"`
		RegularRetailPrice      *string                  `json:"regularRetailPrice"`
		CatalogProductVariantID *string                  `json:"catalogProductVariantId"`
		Selector                []ProductVariantSelector `json:"selector"`
		Items                   []Item                   `json:"items"`
		Inventory               []Inventory              `json:"inventory"`
	}

	ProductVariantSelector struct {
		Name  string `json:"name"`
